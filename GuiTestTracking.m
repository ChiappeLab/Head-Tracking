...
v = VideoReader('H:\Raw Data TB Background\T4T5\SplitT4T5OtdKIR\Fly 3268\2_0.avi');
f = figure('Visible', 'off', 'Position', [360, 300, 500, 320]);
bckImg = imread('H:\Video Backgrounds\BackgroundDarkApril2018.tif');%BackgroundDarkApril2018.tif');%[pwd '\BckgDecember2017.tif']);
